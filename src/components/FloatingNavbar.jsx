...
function FloatingNavbar() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 bg-white text-gray-700 rounded-full shadow-2xl border border-[#45cad7] px-2 py-2 flex justify-between items-center gap-2 z-50">
      <NavLink
        to="/"
        className={`${baseClass} ${
          isActive("/")
