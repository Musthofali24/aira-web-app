...
function Settings() {
  ...
  if (loading) {
    return (
      <div className="bg-gradient-to-b from-[#45cad7] to-[#3bb4c1] text-white min-h-screen py-5 mb-20">
        <div className="max-w-4xl mx-auto bg-[#e8fdff] min-h-screen rounded-2xl p-6 shadow-lg flex items-center justify-center">
  ...
  return (
    <div className="grid grid-cols-1 gap-3 bg-gradient-to-b bg-[#45cad7] text-white min-h-screen mb-20 px-4">
      ...
      <div className="min-w-4xl mx-auto bg-[#e8fdff] min-h-screen rounded-2xl py-4 sm:py-7 px-3 sm:px-6 shadow-lg space-y-3">
        {/* Settings Content */}
        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm min-h-[400px]">
          {/* Notifications Settings */}
          {activeSection === "notifications" && (
            <div className="space-y-6">
              <h2 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <i className="ri-notification-3-line text-[#45cad7]"></i>
              ...
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <select
                  ...
                  className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#45cad7] focus:border-transparent text-gray-800 bg-white"
                >
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <input
                    ...
                    className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#45cad7] text-gray-800 bg-white"
                  />
          ...
          {activeSection === "display" && (
            <div className="space-y-6">
              <h2 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <i className="ri-palette-line text-[#45cad7]"></i>
                Pengaturan Tampilan
              </h2>

              {/* Theme Selection */}
              <div className="p-4 bg-gray-50 rounded-lg">
                <h3 className="font-semibold text-gray-800 mb-3">Mode Tema</h3>
                  ...
                  {themeOptions.map((theme) => (
                    ...
                    >
                      <input
                        ...
                        className="sr-only"
                      />
                      <i className={`${theme.icon} text-xl text-gray-600`}></i>
              ...
              {/* Language */}
              <div className="p-4 bg-gray-50 rounded-lg">
                <h3 className="font-semibold text-gray-800 mb-2">Bahasa</h3>
                <select
                  ...
                  >
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        ...
                        onChange={(e) =>
                          updateSetting("display", option.key, e.target.checked)
                        }
                        className="sr-only peer"
                      />
                      <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#45cad7]"></div>
          ...
          {activeSection === "sensor" && (
            <div className="space-y-6">
              <h2 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <i className="ri-sensor-line text-[#45cad7]"></i>
                Pengaturan Sensor
              </h2>
                  ...
                  >
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        ...
                        onChange={(e) =>
                          updateSetting("sensor", option.key, e.target.checked)
                        }
                        className="sr-only peer"
                      />
                      <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#45cad7]"></div>
        ...
        <div className="fixed inset-0 backdrop-blur-md bg-transparent flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl p-6 max-w-md w-full mx-4 shadow-2xl transform transition-all duration-300 scale-100">
            ...
            <div className="flex gap-3">
              <button
                onClick={() => navigate("/")}
                className="flex-1 bg-[#45cad7] text-white py-2 px-4 rounded-lg font-medium hover:bg-[#3bb4c1] transition-colors duration-200 flex items-center justify-center gap-2"
              >
